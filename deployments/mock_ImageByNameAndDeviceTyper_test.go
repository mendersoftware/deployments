...
// MockImageByNameAndDeviceTyper is an autogenerated mock type for the ImageByNameAndDeviceTyper type
type MockImageByNameAndDeviceTyper struct {
	mock.Mock
}

// ImageByNameAndDeviceType provides a mock function with given fields: name, deviceType
func (_m *MockImageByNameAndDeviceTyper) ImageByNameAndDeviceType(name string, deviceType string) (*images.SoftwareImage, error) {
