...
const (
	...
	SettingDirectUploadSkipVerify        = "direct_upload_skip_verify"
	SettingDirectUploadSkipVerifyDefault = false
...
var (
	...
	Defaults = []config.Default{
		...
		{Key: SettingDirectUploadSkipVerify, Value: SettingDirectUploadSkipVerifyDefault},
