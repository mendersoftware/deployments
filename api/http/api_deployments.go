...
type Config struct {
	...
	// EnableDirectUploadSkipVerify allows to disable veryfication of uploaded artifacts
...
func (d *DeploymentsApiHandlers) CompleteUpload(w rest.ResponseWriter, r *rest.Request) {
	...
	err := d.app.CompleteUpload(ctx, artifactID, d.config.EnableDirectUploadSkipVerify) // here
