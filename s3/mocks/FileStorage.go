...
// GetRequest provides a mock function with given fields: ctx, objectId, duration, responseContentType, fileName
func (_m *FileStorage) GetRequest(ctx context.Context, objectId string, duration time.Duration, responseContentType string, fileName string) (*model.Link, error) {
	ret := _m.Called(ctx, objectId, duration, responseContentType, fileName)

	var r0 *model.Link
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Duration, string, string) *model.Link); ok {
		r0 = rf(ctx, objectId, duration, responseContentType, fileName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Link)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, time.Duration, string, string) error); ok {
		r1 = rf(ctx, objectId, duration, responseContentType, fileName)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *FileStorage) ListBuckets(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
// UploadArtifact provides a mock function with given fields: ctx, objectId, artifact, contentType
