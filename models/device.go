...
const (
	DeviceDeploymentStatusInProgress string = "inprogress"
	DeviceDeploymentStatusPending    string = "pending"
	DeviceDeploymentStatusSuccess    string = "success"
	DeviceDeploymentStatusFailure    string = "failure"
	DeviceDeploymentStatusNoImage    string = "noimage"
)
