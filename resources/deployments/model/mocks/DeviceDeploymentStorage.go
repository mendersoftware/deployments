...
import deploymentsmodel "github.com/mendersoftware/deployments/model"
...
func (_m *DeviceDeploymentStorage) AssignArtifact(ctx context.Context, deviceID string, deploymentID string, artifact *deploymentsmodel.SoftwareImage) error {
	ret := _m.Called(ctx, deviceID, deploymentID, artifact)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *deploymentsmodel.SoftwareImage) error); ok {
