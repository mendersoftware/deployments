...
// MockDeviceDeploymentStorage is an autogenerated mock type for the DeviceDeploymentStorage type
type MockDeviceDeploymentStorage struct {
	mock.Mock
}

// ExistAssignedImageWithIDAndStatuses provides a mock function with given fields: id, statuses
func (_m *MockDeviceDeploymentStorage) ExistAssignedImageWithIDAndStatuses(id string, statuses ...string) (bool, error) {
...
func (_m *MockDeviceDeploymentStorage) FindOldestDeploymentForDeviceIDWithStatuses(deviceID string, statuses ...string) (*deployments.DeviceDeployment, error) {
...
func (_m *MockDeviceDeploymentStorage) InsertMany(deployment ...*deployments.DeviceDeployment) error {
