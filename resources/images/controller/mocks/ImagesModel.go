...
func (_m *ImagesModel) DownloadLink(ctx context.Context, imageID string, expire time.Duration) (*model.Link, error) {
...
func (_m *ImagesModel) EditImage(ctx context.Context, id string, constructorData *model.SoftwareImageMetaConstructor) (bool, error) {
...
func (_m *ImagesModel) GetImage(ctx context.Context, id string) (*model.SoftwareImage, error) {
...
func (_m *ImagesModel) ListImages(ctx context.Context, filters map[string]string) ([]*model.SoftwareImage, error) {
